    ...
    <>
      {isLoading ? (
        ...
        <div className="archive-product-container raw-mats-cont">
          ...
          >
            <div className="inventory-stock-container d-flex pe-3">
              <h2>Raw Materials</h2>

              <div className="input-group first-col group-in">
                <input
                  type="text"
            ...
            >
              ...
              >
                ...
                <div className="add-material-footer d-flex flex-row justify-content-end">
                  <Button variant="danger" className="me-2" onClick={handleAddMaterialToggle} style={{ fontSize: "1.5em" }}>
                    Cancel
                  </Button>
                  <Button type="submit" variant="primary" style={{ fontSize: "1.5em" }}>
                    Save
                  </Button>
                </div>
              </Form>
                ...
                <div className="col-6">
                  ...
                  <div class="form-floating">
                    <textarea
                      ...
                      placeholder="Leave a comment here"
                      id="floatingTextarea2"
                      style={{ height: "100px", fontSize: "1.2em", paddingTop: "20px" }}
                      onChange={(e) => setDescription(e.target.value)}
                      value={description}
                    ></textarea>
