          ...
          dataForExport
            .map((data) => {
              ...
              return `${fullName},${
                ...
                ? `${data.product_inventory.product.name} (${data.cart_specification_variants.map(variant => variant.specification_variant.variant_name).join(", ")})`
                : data.product_inventory.product.name},${
                data.product_inventory.product.price
              },${data.quantity},${formatDate(data.createdAt)}`;
            })
            .join("\n");
          ...
          <div className="custom-card inv-card">
            <div className="pos-head-container">
              <div className="title-content-field">
                <h2>Customer Report Transaction</h2>
